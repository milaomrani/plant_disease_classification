...
def parse_arguments():
    ...
    parser.add_argument("--load_size", type=int, default=64, help="image size")
    parser.add_argument("--model", type=str, default="TinyVgg", help="Model architecture: TinyVgg or ImageNet")
